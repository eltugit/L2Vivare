                        ...
                        if (d.getNodeName().equalsIgnoreCase("dress")) {
                            ...
                            for (Node att = d.getFirstChild(); att != null; att = att.getNextSibling()) {
                                if ("set".equalsIgnoreCase(att.getNodeName())) {
                                    ...
                                    Node isSuitNode = att.getAttributes().getNamedItem("isSuit");
                                    isSuit = (isSuitNode != null) && Boolean.parseBoolean(isSuitNode.getNodeValue());
                                }
                            ...
                            getHolder().addDress(new DressMeArmorData(id, name, type, chest, legs, gloves, feet, itemId, itemCount, isSuit));
                        }
                    }
                }
            }
