package gabriel.enchantColor.runnable;
...
public class RequestPreviewEnchantColor extends L2GameClientPacket {
    private static final String _C__C7_REQUESTPREVIEWITEM = "[C] C7 RequestPreviewItem";
    protected static final Logger _log = Logger.getLogger(RequestPreviewEnchantColor.class.getName());
    ...
    public static class RemoveWearItemsTask implements Runnable {
        ...
        public void run() {
            try {
                activeChar.deleteQuickVar("tryEnchant");
