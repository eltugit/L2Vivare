...
public class CSKOTHEventTeam {
    ...
    public void set_coordinates(int[] _coordinates) {
    ...
    public void setCapturePoints(int _capturePoints) {
        this._capturePoints = _capturePoints;
    }

    public void incCapturePoints(){
        _capturePoints += 3;
    }
     ...
     */
    public CSKOTHEventTeam(String name, int[] coordinates) {
        _name = name;
