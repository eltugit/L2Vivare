package gabriel.scriptsGab.donatesystem.xml;

import gabriel.scriptsGab.donatesystem.*;
...
public final class DonationParse extends AbstractFileParser<DonationHolder> {
    ...
    protected void readData() {
        ...
        try {
            ...
            org.dom4j.Document document = _reader.read(inputstream);
            Element rootElement = document.getRootElement();

            Donation donate;
            for (Iterator<?> iterator = rootElement.elementIterator("donation");
                 iterator.hasNext(); getHolder().addDonate(donate)) {
