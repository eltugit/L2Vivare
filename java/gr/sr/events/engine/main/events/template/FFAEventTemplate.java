...
public class FFAEventTemplate extends AbstractMainEvent
{
    ...
    public FFAEventTemplate(final EventType type, final MainEventManager manager) {
        super(type, manager);
    ...
    private class CustomEventInstance extends AbstractEventInstance
    {
        ...
        public void run() {
            try {
                switch (this._state) {
                    case START: {
                        if (FFAEventTemplate.this.checkPlayers(this._instance.getId())) {
                    ...
                    case END: {
                        ...
                        if (!FFAEventTemplate.this.instanceEnded() && this._canBeAborted) {
