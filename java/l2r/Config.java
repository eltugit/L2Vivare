...
import gabriel.proxies.ProxyA;
import gabriel.proxies.ProxyB;
...
{
	public static final Map<Integer, String> PROTOCOLMAPPER = new ConcurrentHashMap<>();
	...
	private static final String PROTOCOL = "./config/network/Protocol.ini";
	private static final String PROXIES = "./config/network/Proxies.ini";
	/** Network settings */
	...
	public static final String ARENA_CONFIG_FILE = "./config/gabriel/arenas.ini";
	
	// --------------------------------------------------
	// L2J Variable Definitions
	// --------------------------------------------------
	public static List<Integer> OPTMIZE_SKILL_LIST = new ArrayList<>();
	public static List<Integer> SELF_SKILL_LIST = new ArrayList<>();
	public static int MAX_SKILL_RADIUS;
	public static int MAX_ATTACK_RADIUS;
	public static boolean ENABLE_CUSTOM_OPTIMIZE;
	
	public static int SKILL_DELAY_1;
	public static int SKILL_DELAY_2;
	...
	public static boolean DEBUG_BYPASS_DIR;
	public static boolean DEBUG_MULTISELL_DIR;
	public static boolean DEBUG_MULTISELL_PRICES;
	...
	public static int ENCHANT_LIMIT_ARMOR;
	public static int ENCHANT_LIMIT_WEAPON;
	public static boolean ARENA_EVENT_ENABLED_LOL;
	public static boolean ARENA_EVENT_PREVENT_IP;
	public static boolean ARENA_EVENT_PREVENT_IP_LOL;
	public static String ARENA_DIAS_RUN;
	public static String ARENA_DIAS_RUN_LOL;
	public static int ARENA_TEAM1_X;
	public static int ARENA_TEAM1_Y;
	public static int ARENA_TEAM1_Z;
	public static int ARENA_TEAM2_X;
	public static int ARENA_TEAM2_Y;
	public static int ARENA_TEAM2_Z;
	public static int ARENA_TELEPORTBACK_X;
	public static int ARENA_TELEPORTBACK_Y;
	public static int ARENA_TELEPORTBACK_Z;
	...
	public static int ARENA_CHECK_INTERVAL_LOL;
	public static int ARENA_CALL_INTERVAL_LOL;
	public static int ARENA_WAIT_INTERVAL_LOL;
	public static boolean ARENA_ENABLE_AUTOMATED;
	public static boolean ARENA_ENABLE_AUTOMATED_LOL;
	public static int ARENA_DURATION_PERIOD;
	public static int ARENA_DURATION_PERIOD_LOL;
	public static String[] ARENA_EVENT_INTERVAL;
	public static String[] ARENA_EVENT_INTERVAL_LOL;
	public static String ARENA_EVENT_DUELS;
	public static String ARENA_EVENT_DUELS_LOL;

	public static int[] ARENA_BANNED_CLASSES = new int[100];
	public static int[] ARENA_BANNED_CLASSES_ARENAS = new int[100];
	public static int ARENA_TIME_RUN_MAX;
	...
	public void loadConfigs()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			OPTMIZE_SKILL_LIST = new ArrayList<>();
			for (String id : Character.getProperty("OptimizeSkillList", "0").split(","))
			{
				OPTMIZE_SKILL_LIST.add(Integer.parseInt(id));
			}
			
			SELF_SKILL_LIST = new ArrayList<>();
			for (String id : Character.getProperty("SelfSkillList", "0").split(","))
			{
				SELF_SKILL_LIST.add(Integer.parseInt(id));
			}
			
			MAX_SKILL_RADIUS = Character.getInt("MAX_SKILL_RADIUS", 1200);
			MAX_ATTACK_RADIUS = Character.getInt("MAX_ATTACK_RADIUS", 1200);
			ENABLE_CUSTOM_OPTIMIZE = Character.getBoolean("ENABLE_CUSTOM_OPTIMIZE", false);
			
			SKILL_DELAY_1 = Character.getInt("SKILL_DELAY_1", 3000);
			SKILL_DELAY_2 = Character.getInt("SKILL_DELAY_2", 10000);
			...
			if (Character.getString("AltGameCancelByHit", "Cast").equalsIgnoreCase("none"))
			{
				ALT_GAME_CANCEL_BOW = false;
				ALT_GAME_CANCEL_CAST = false;
			}
			else
			{
			...
			//
			// final PropertiesParser protocolSettings = new PropertiesParser("./config/network/Protocol.ini");
			// String a = protocolSettings.getProperty("AllowedProtocols", "Prelude, C1, C2, C3, C4, C5, Interlude, Kamael, Hellbound, Gracia1, Gracia2, GraciaFinal, Epilogue, Freya, HighFive, Awakening, Harmony, Tauti, GloryDays, Livindor, Valiance, Ertheia");
			// if (a.equals("All")) {
			// a = "Prelude, C1, C2, C3, C4, C5, Interlude, Kamael, Hellbound, Gracia1, Gracia2, GraciaFinal, Epilogue, Freya, HighFive, Awakening, Harmony, Tauti, GloryDays, Livindor, Valiance, Ertheia";
			// }
			// for (final String s : a.replace(" ", "").split(",")) {
			// final int intValue = Integer.decode(protocolSettings.getProperty(s, "-1"));
			// if (intValue >= 0) {
			// PROTOCOLMAPPER.put(intValue, s);
			// }
			// }
			//
			// for (final String s2 : new PropertiesParser("./config/network/Proxies.ini").getProperty("Proxies", "1-2,proxy_asia.lgameserver.eu;").split(";")) {
			// try {
			// final ProxyB b = new ProxyB(Integer.parseInt(s2.split("-")[1].split(",")[0]), InetAddress.getByName(s2.split("-")[1].split(",")[1]).getAddress(), Integer.parseInt(s2.split("-")[0]));
			// ProxyA.a.put(b.serverId, b);
			// }
			// catch (Exception ex2) {
			// ex2.printStackTrace();
			// }
			...
			final PropertiesParser arenaSettings = new PropertiesParser(ARENA_CONFIG_FILE);
			ARENA_EVENT_ENABLED = Boolean.parseBoolean(arenaSettings.getProperty("ArenaEventEnabled", "false"));
			ARENA_EVENT_ENABLED_LOL = Boolean.parseBoolean(arenaSettings.getProperty("ArenaEventEnabled_LOL", "false"));

			if (ARENA_EVENT_ENABLED || ARENA_EVENT_ENABLED_LOL) {
				ARENA_DIAS_RUN = arenaSettings.getProperty("ArenaDiasRun", "2,3");
				ARENA_DIAS_RUN_LOL = arenaSettings.getProperty("ArenaDiasRun_LOL", "2,3");
				ARENA_CHECK_INTERVAL_LOL = Integer.parseInt(arenaSettings.getProperty("ArenaBattleCheckInterval_LOL", "15")) * 1000;
				ARENA_CALL_INTERVAL_LOL = Integer.parseInt(arenaSettings.getProperty("ArenaBattleCallInterval_LOL", "60")) * 1000;
				ARENA_WAIT_INTERVAL_LOL = Integer.parseInt(arenaSettings.getProperty("ArenaBattleWaitInterval_LOL", "20")) * 1000;
				...
				if (ARENA_CALL_INTERVAL < 30000)
				{
					ARENA_CALL_INTERVAL = 30000;
				}
				
				ARENA_WAIT_INTERVAL = Integer.parseInt(arenaSettings.getProperty("ArenaBattleWaitInterval", "20")) * 1000;
				
				ARENA_TEAM1_X = Integer.parseInt(arenaSettings.getProperty("Team1XLoc", "148725"));
				ARENA_TEAM1_Y = Integer.parseInt(arenaSettings.getProperty("Team1YLoc", "46768"));
				ARENA_TEAM1_Z = Integer.parseInt(arenaSettings.getProperty("Team1ZLoc", "-3413"));
				
				ARENA_TEAM2_X = Integer.parseInt(arenaSettings.getProperty("Team2XLoc", "150154"));
				ARENA_TEAM2_Y = Integer.parseInt(arenaSettings.getProperty("Team2YLoc", "46752"));
				ARENA_TEAM2_Z = Integer.parseInt(arenaSettings.getProperty("Team2ZLoc", "-3413"));
				
				ARENA_TELEPORTBACK_X = Integer.parseInt(arenaSettings.getProperty("TeleporBackXLoc", "82937"));
				ARENA_TELEPORTBACK_Y = Integer.parseInt(arenaSettings.getProperty("TeleporBackYLoc", "148646"));
				ARENA_TELEPORTBACK_Z = Integer.parseInt(arenaSettings.getProperty("TeleporBackZLoc", "-3469"));
				ARENA_ENABLE_AUTOMATED_LOL = Boolean.parseBoolean(arenaSettings.getProperty("EventAutomatedEnabled_LOL", "true"));

				ARENA_ENABLE_AUTOMATED = Boolean.parseBoolean(arenaSettings.getProperty("EventAutomatedEnabled", "true"));
				if (ARENA_ENABLE_AUTOMATED)
				{
					ARENA_DURATION_PERIOD = Integer.parseInt(arenaSettings.getProperty("EventDurationMinutes", "60"));
					ARENA_EVENT_INTERVAL = arenaSettings.getProperty("EventAllowedTime", "8:00,9:00").split(",");
				}
				if (ARENA_ENABLE_AUTOMATED_LOL)
				{
					ARENA_DURATION_PERIOD_LOL = Integer.parseInt(arenaSettings.getProperty("EventDurationMinutes_LOL", "60"));
					ARENA_EVENT_INTERVAL_LOL = arenaSettings.getProperty("EventAllowedTime_LOL", "8:00,9:00").split(",");
				}
				ARENA_EVENT_DUELS = arenaSettings.getProperty("ArenaEventDuels", "2,3,4,5,6,9");
				ARENA_EVENT_DUELS_LOL = arenaSettings.getProperty("ArenaEventDuels_LOL", "1,2,9");

				String[] dmClassBan = arenaSettings.getProperty("EventBannedClassesId", "15,16,17,42,43,90,91,97,98,99,105,106,112,136").split(",");
				
				for (int i = 0; i < dmClassBan.length; i++)
				{
					ARENA_BANNED_CLASSES[i] = Integer.parseInt(dmClassBan[i]);
				}
				String[] dmClassBanArenas = arenaSettings.getProperty("EventBannedClassesIdArenas", "7,8,9").split(",");
				
				for (int i = 0; i < dmClassBanArenas.length; i++)
				{
					ARENA_BANNED_CLASSES_ARENAS[i] = Integer.parseInt(dmClassBanArenas[i]);
				}
				ARENA_TIME_RUN_MAX = Integer.parseInt(arenaSettings.getProperty("ArenaTimeRun", "10"));
				ARENA_EVENT_PREVENT_IP = Boolean.parseBoolean(arenaSettings.getProperty("PreventSameIp", "false"));
				ARENA_EVENT_PREVENT_IP_LOL = Boolean.parseBoolean(arenaSettings.getProperty("PreventSameIp_LOL", "false"));
			...
			DEBUG_BYPASS_DIR = Debug.getBoolean("DebugBypassUsage", true);
			DEBUG_MULTISELL_DIR = Debug.getBoolean("DebugMultisellDir", true);
			DEBUG_MULTISELL_PRICES = Debug.getBoolean("DebugMultisellPrices", true);
		...
		else if (Server.serverMode == Server.MODE_LOGINSERVER)
		{
            ...
            final PropertiesParser proxies = new PropertiesParser("./config/network/Proxies.ini");
            String[] proxs = proxies.getProperty("Proxies", "1-2,proxy_asia.lgameserver.eu;").split(";");
            if (proxs.length > 0) {
                for (final String s2 : proxs) {
                    if (s2.isEmpty())
                        continue;
                    try {
                        final ProxyB b = new ProxyB(Integer.parseInt(s2.split("-")[1].split(",")[0]),
                                InetAddress.getByName(s2.split("-")[1].split(",")[1]).getAddress(),
