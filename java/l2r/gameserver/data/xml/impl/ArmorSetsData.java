...
public final class ArmorSetsData implements IXmlReader
{
    ...
    public Map<Integer, L2ArmorSet> getSetByItemId(int itemId, int slot){
        Map<Integer, L2ArmorSet> map = new HashMap<>();
        for (Map.Entry<Integer, L2ArmorSet> entry : _armorSets.entrySet()) {
            if(entry.getValue().containItem(slot, itemId)){
