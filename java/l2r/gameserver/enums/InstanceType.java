...
public enum InstanceType
{
	...
	L2InterServerExchangeInstance(L2Npc),
	...
	// Siege
	L2CSKOTHEventNpcInstance(L2Npc),
    ...
    L2WeeklyRankManagerNpcInstance(L2Npc),
	L2MuseumStatueInstance(L2Npc),
    L2KOTHEventNpcInstance(L2Npc),
    L2ExtremeEventNpcInstance(L2Npc),
    L2CSEventNpcInstance(L2Npc),
    L2EREventNpcInstance(L2Npc);
