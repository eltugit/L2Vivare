...
public class Shortcut
{
	...
	public Shortcut(int slot, int page, int type, int id, int level, int characterType)
	{
		_slot = slot;
		_page = page;
		_type = getRightType(type);
		_id = id;
		_level = level;
		_characterType = characterType;
	}

	private ShortcutType getRightType(int type){
	    switch (type){
            case 0 : return ShortcutType.NONE;
            case 1 : return ShortcutType.ITEM;
            case 2 : return ShortcutType.SKILL;
            case 3 : return ShortcutType.ACTION;
            case 4 : return ShortcutType.MACRO;
            case 5 : return ShortcutType.RECIPE;
            case 6 : return ShortcutType.BOOKMARK;
        }
