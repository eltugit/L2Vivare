...
//TODO GABRIEL: CHECK THIS METHOD! IS BUGGING SOMETHINGS

//        if(GabConfig.TW_GABRIEL_CONFIG) {
//		if(!WardLimiter.canSummonWard(player)){
//		    player.sendMessage("Your clan already have the max amount of Territory Wards! You cant get one more!");
//            player.destroyItem("CombatFlag", item, null, true);
//            spawnMe();
//            return false;
//        }else if(GabConfig.ONE_WARD_AT_TIME_CLAN && WardLimiter.clanHasWardAlready(player)){
//
//            player.sendMessage("One of your Clan member is already holding a Combat Flag! You can't hold more than one at the time. Go and Summon it first!");
//            player.destroyItem("CombatFlag", item, null, true);
//            spawnMe();
//            return false;
//        }
