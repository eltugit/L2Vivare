...
public class TradeItem {
    ...
    private L2Augmentation _augmentationObject;
    ...
    public TradeItem(L2ItemInstance item, long count, long price) {
        ...
        _augmentationObject = item.isAugmented() ? item.getAugmentation() : null;
    ...
    public TradeItem(TradeItem item, long count, long price) {
        ...
        _augmentationObject = item.getAugmentationObject();
        _type1 = item.getCustomType1();
        _type2 = item.getCustomType2();
        _count = count;
        _storeCount = count;
    ...
    public L2Augmentation getAugmentationObject() {
        return _augmentationObject;
    }
