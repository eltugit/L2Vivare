...
//						String clan = ((L2PcInstance)this).getClan() != null ? " of clan " +getActingPlayer().getClan().getName() : "";
//						CreatureSay ct = new CreatureSay(0, Say2.BATTLEFIELD, "", " "+this.getName()+ clan + " was SELF :");
