...
public final class L2AioNpcInstance extends L2Npc
{
	...
	public void sendPacket(L2PcInstance player, String html)
	{
		...
		msg.setFile(player, player.getHtmlPrefix(), "/data/html/sunrise/AioNpc/" + html);
	...
	public void showChatWindow(L2PcInstance player)
	{
		...
		html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/main.htm");
	...
	public void onBypassFeedback(final L2PcInstance player, String command)
	{
		...
		if (command.startsWith("Chat"))
		{
			...
			NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/" + subCommand[1]);
			html.replace("%objectId%", String.valueOf(getObjectId()));
			player.sendPacket(html);
		}
		...
		else if (command.toLowerCase().startsWith(COMMANDS[0])) // WithdrawP
		{
			...
			{
				NpcHtmlMessage msg = new NpcHtmlMessage(getObjectId());
				msg.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/warehouse/WhSortedP.htm");
				msg.replace("%objectId%", String.valueOf(getObjectId()));
				player.sendPacket(msg);
			}
			else
		...
		else if (command.startsWith("Subclass"))
		{
			...
			{
				html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_NoTransformed.htm");
				player.sendPacket(html);
				return;
			}
			...
			{
				html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_NoSummon.htm");
				player.sendPacket(html);
				return;
			}
			...
			switch (cmdChoice)
			{
				...
				case 1: // Add Subclass - Initial
					...
					{
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_Add.htm");
					...
					else
					{
						...
						{
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_Fail_Elves.htm");
							player.sendPacket(html);
						}
						else if (player.getRace() == Race.KAMAEL)
						{
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_Fail_Kamael.htm");
							player.sendPacket(html);
						}
						else
						{
				...
				case 2: // Change Class - Initial
					...
					{
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ChangeNo.htm");
					}
					else
					{
						...
						{
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_Change.htm");
							html.replace("%list%", content2.toString());
						}
						else
						{
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ChangeNotFound.htm");
						}
					}
					break;
				case 3: // Change/Cancel Subclass - Initial
					...
					{
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyEmpty.htm");
						break;
					}
					...
					{
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyCustom.htm");
					...
					else
					{
						...
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_Modify.htm");
				...
				case 4: // Add Subclass - Action (Subclass 4 x[x])
					...
					if (allowAddition && Conditions.isValidNewSubClass(player, paramOne))
					{
						...
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_AddOk.htm");
				...
				case 5: // Change Class - Action
					...
					{
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_Current.htm");
						break;
					}
				...
				case 6: // Change/Cancel Subclass - Choice
					...
					{
						case 1:
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyChoice1.htm");
							break;
						case 2:
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyChoice2.htm");
							break;
						case 3:
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyChoice3.htm");
							break;
						default:
							html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyChoice.htm");
					}
				...
				case 7: // Change Subclass - Action
					...
					if (player.modifySubClass(paramOne, paramTwo))
					{
						...
						html.setFile(player, player.getHtmlPrefix(), "data/html/sunrise/AioNpc/subclass/SubClass_ModifyOk.htm");
