...
public class L2CastleDoormenInstance extends L2DoormenInstance
{
	...
	{
		if(CSKOTHEvent.isStarted() && CSKOTHEvent.owner != null && CSKOTHEvent.getParticipantTeam(player.getObjectId()) != null && CSKOTHEvent.owner.getName().equals(CSKOTHEvent.getParticipantTeam(player.getObjectId()).getName()))
			return;
	...
	{
		if(CSKOTHEvent.isStarted() && CSKOTHEvent.getParticipantTeam(player.getObjectId()) != null){
			if(CSKOTHEvent.owner != null && CSKOTHEvent.owner.getName().equals(CSKOTHEvent.getParticipantTeam(player.getObjectId()).getName()))
				return true;
			else
				return false;
		}
