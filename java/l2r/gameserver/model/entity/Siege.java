...
public class Siege implements Siegable
{
	...
	public void endSiege()
	{
        ...
        SiegeRankManager.getInstance().sendToEveryOne(true);
	...
	public void startSiege()
	{
		if (!isInProgress())
		{
            ...
            SiegeRankManager.getInstance().resetStart(true);
    ...
    private void setNextSiegeDate()
    {
        ...
        if(GabConfig.CUSTOM_SIEGE_TIME){
            while (cal.getTimeInMillis() < Calendar.getInstance().getTimeInMillis()) {
                switch (getCastle().getResidenceId()) {
                    case 1: // Gludio
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEGludio);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_GLUDIO);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_GLUDIO);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_GLUDIO);
                        break;
                    case 2: // Dion
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEDion);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_DION);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_DION);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_DION);
                        break;
                    case 3: // Giran
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEGiran);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_GIRAN);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_GIRAN);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_GIRAN);
                        break;
                    case 4: // Oren
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEOren);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_OREN);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_OREN);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_OREN);
                        break;
                    case 5: // Aden
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEAden);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_ADEN);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_ADEN);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_ADEN);
                        break;
                    case 6: // Innadril/Heine
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEInnadril);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_INNADRIL);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_INNADRIL);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_INNADRIL);
                        break;
                    case 7: // Goddard
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLEGoddard);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_GODDARD);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_GODDARD);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_GODDARD);
                        break;
                    case 8: // Rune
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLERune);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_RUNE);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_RUNE);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_RUNE);
                        break;
                    case 9: // Schuttgart
                        cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAYCASTLESchuttgart);
                        cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_OF_SIEGE_SCHUT);
                        cal.set(Calendar.MINUTE, GabConfig.MINUTE_OF_SIEGE_SCHUT);
                        cal.set(Calendar.SECOND, GabConfig.SECOND_OF_SIEGE_SCHUT);
                        break;
                    default:
                        System.out.println("Siege Castle Id "+ getCastle().getResidenceId() + " Not found, using Gludio Configuration Date!.");
                ...
                cal.add(Calendar.WEEK_OF_YEAR, GabConfig.NEXT_SIEGE_TIME);
