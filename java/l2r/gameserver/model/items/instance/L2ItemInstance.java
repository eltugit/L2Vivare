...
public final class L2ItemInstance extends L2Object
{
    ...
    public L2ItemInstance(int objectId, L2ItemInstance l2ItemInstance) {
        super(objectId);
        this._ownerId = l2ItemInstance._ownerId;
        this.visualItemId = l2ItemInstance.visualItemId;
        this._dropperObjectId = l2ItemInstance._dropperObjectId;
        this._count = l2ItemInstance._count;
        this._initCount = l2ItemInstance._initCount;
        this._time = l2ItemInstance._time;
        this._decrease = l2ItemInstance._decrease;
        this._itemId = l2ItemInstance._itemId;
        this._item = l2ItemInstance._item;
        this._loc = l2ItemInstance._loc;
        this._locData = l2ItemInstance._locData;
        this._enchantLevel = l2ItemInstance._enchantLevel;
        this._wear = l2ItemInstance._wear;
        this._augmentation = l2ItemInstance._augmentation;
        this._mana = l2ItemInstance._mana;
        this._consumingMana = l2ItemInstance._consumingMana;
        this._type1 = l2ItemInstance._type1;
        this._type2 = l2ItemInstance._type2;
        this._dropTime = l2ItemInstance._dropTime;
        this._published = l2ItemInstance._published;
        this._protected = l2ItemInstance._protected;
        this._lastChange = l2ItemInstance._lastChange;
        this._existsInDb = l2ItemInstance._existsInDb;
        this._storedInDb = l2ItemInstance._storedInDb;
        this._elementals = l2ItemInstance._elementals;
        this.itemLootShedule = l2ItemInstance.itemLootShedule;
        this._lifeTimeTask = l2ItemInstance._lifeTimeTask;
    }

	public L2ItemInstance(int objectId, L2ItemInstance l2ItemInstance, boolean newitem) {
		super(objectId);
		this._ownerId = l2ItemInstance._ownerId;
		this.visualItemId = l2ItemInstance.visualItemId;
		this._dropperObjectId = l2ItemInstance._dropperObjectId;
	...
	public final void pickupMe(L2Character player)
	{
		...
		// vGodFather: just in case for client leaks
	...
	public void setOwnerId(String process, int owner_id, L2PcInstance creator, Object reference)
	{
		...
		if (creator != null)
		{
			if (creator.isGM())
			{
				...
				{
					referenceName = (!((L2Object) reference).getName().isEmpty() ? ((L2Object) reference).getName() : "no-name");
				}
    ...
    public void setLocData(int _locData) {
        this._locData = _locData;
    }
	...
	public int isEnchantable()
	{
		...
		{
            if(getItem().isHeroItem() && GabConfig.ALLOW_ENCHANT_HERO)
                return 1;
	...
	public boolean isTradeable()
	{
        ...
        if (getVisualItemId() != 0) return false;

        if (isAugmented()) {
            return GabConfig.TRADEABLE_AUGMENTATION;
        }
	...
	public void setElementals(Elementals[] elementals){
	    _elementals = elementals;
    }

	public int getElementCount(){
	    if(_elementals == null) return 0;
	    else return _elementals.length;
    }
	...
	public void applyAttribute(byte element, int value)
	{
		if (_elementals == null)
		{
	...
	public boolean isElementable()
	{
		if ((getItemLocation() == ItemLocation.INVENTORY) || (getItemLocation() == ItemLocation.PAPERDOLL))
		{
            if(getItem().isHeroItem() && GabConfig.ALLOW_ELEMENT_HERO)
                return true;
            if(getItem().isPvpItem() && GabConfig.ALLOW_ELEMENT_PVP)
                return true;
	...
	public int getOlyEnchantLevel()
	{
		...
		int limit = isWeapon() ? Config.ENCHANT_LIMIT_WEAPON : Config.ENCHANT_LIMIT_ARMOR;
		if(player.isInArenaEvent() && (limit >= 0) && (enchant > limit)){
			enchant = limit;
		}
    ...
    {
        return getItem().getBodyPart() == L2Item.SLOT_BELT;
    }

    public boolean isBracelet()
    {
        return (getItem().getBodyPart() == L2Item.SLOT_R_BRACELET) || (getItem().getBodyPart() == L2Item.SLOT_L_BRACELET);
    }

    public boolean isUnderwear()
    {
        return getItem().getBodyPart() == L2Item.SLOT_UNDERWEAR;
    }

    public boolean isCloak()
    {
        return getItem().getBodyPart() == L2Item.SLOT_BACK;
    }

    public boolean isTalisman()
    {
        return getItem().getBodyPart() == L2Item.SLOT_DECO;
    }
