...
public class L2SkillSummon extends L2Skill
{
	...
	public void useSkill(L2Character caster, L2Object[] targets)
	{
		...
		final Location loc = GeoData.getInstance().moveCheck(activeChar, new Location(activeChar.getX() + 20, activeChar.getY() + 20, activeChar.getZ()));
		summon.spawnMe(loc.getX(), loc.getY(), loc.getZ());
	}
