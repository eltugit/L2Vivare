...
public final class SystemMessageId
{
	 ...
	 */
	public static final SystemMessageId NIGHT_EFFECT_S1_APPLIES = new SystemMessageId(1131);
	
	/**
	 * ID: 1132<br>
	 * Message: It is dawn and the effect of $s1 will now disappear.
	 */
	public static final SystemMessageId DAY_EFFECT_S1_DISAPPEARS = new SystemMessageId(1132);
	
	/**
	 * ID: 1133<br>
	 * Message: Since your HP has decreased, the effect of $s1 can be felt.
	 */
	public static final SystemMessageId HP_DECREASED_EFFECT_S1_APPLIES = new SystemMessageId(1133);
	
	/**
	 * ID: 1134<br>
	 * Message: Since your HP has increased, the effect of $s1 will disappear.
	 */
	public static final SystemMessageId HP_INCREASED_EFFECT_S1_DISAPPEARS = new SystemMessageId(1134);
	 ...
	 */
	public static final SystemMessageId YOUR_PET_SERVITOR_IS_UNRESPONSIVE_AND_WILL_NOT_OBEY_ANY_ORDERS = new SystemMessageId(1864);
	 ...
	 */
	public static final SystemMessageId YOUR_PET_IS_TOO_HIGH_LEVEL_TO_CONTROL = new SystemMessageId(1918);
	 ...
	 */
	public static final SystemMessageId YOU_DO_NOT_HAVE_A_SERVITOR = new SystemMessageId(2311);
	
	/**
	 * ID: 2312<br>
	 * Message: You do not have a pet.
	 */
	public static final SystemMessageId YOU_DO_NOT_HAVE_A_PET = new SystemMessageId(2312);
	 ...
	 */
	public static final SystemMessageId THERE_ARE_S2_SECONDS_REMAINING_FOR_S1_REUSE_TIME = new SystemMessageId(3263);
	
	/**
	 * ID: 3264<br>
	 * Message: There are $s2 minutes $s3 seconds remaining for $s1's re-use time. It is reset every day at 6:30 AM.
	 */
	public static final SystemMessageId THERE_ARE_S2_MINUTES_S3_SECONDS_REMAINING_FOR_S1_REUSE_TIME = new SystemMessageId(3264);
	
	/**
	 * ID: 3265<br>
	 * Message: There are $s2 hours $s3 minutes $s4 seconds remaining for $s1's re-use time. It is reset every day at 6:30 AM.
	 */
	public static final SystemMessageId THERE_ARE_S2_HOURS_S3_MINUTES_S4_SECONDS_REMAINING_FOR_S1_REUSE_TIME = new SystemMessageId(3265);
