...
public final class Logout extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (SunriseEvents.isInEvent(player) || (GabUtils.isInPvPInstance(player) && ConfigPvPInstance.ENABLE_PVP_INSTANCE_LOGOUT))
		{
        ...
        if (player.isInTournament()) {
            player.sendMessage("You cannot logout while registered in event.");
            player.sendPacket(ActionFailed.STATIC_PACKET);
            return;
        }
