...
public final class RequestAcquireSkill extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (((_level < 1) || (_level > 1000) || (_id < 1) || (_id > 36000)) && !((_id >= 59500 && _id <= 59537) || (_id >= 10660 && _id <= 10666)))
		{
        ...
        if(!activeChar.getQuickVarB("pomanderUse", false)){
	...
	private void giveSkill(L2PcInstance player, L2Npc trainer, L2Skill skill)
	{
        ...
        player.deleteQuickVar("pomanderUse");
