...
public final class RequestWithdrawalPledge extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
        ...
        if(CustomMethodes.isSiegeActive() && !GabConfig.ALLOW_IKD_CA){
            activeChar.sendMessage("Cannot leave from clan if there is a siege happening.");
            return;
        }
        ...
        GabUtils.verifyClanCloak(activeChar);
