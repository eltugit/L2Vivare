...
public class Die extends L2GameServerPacket
{
	...
	public Die(L2Character cha)
	{
		...
		if (cha.isPlayer())
		{
            ...
            if (activeChar.isInTournament() || activeChar.isInArenaEvent() || (CSKOTHEvent.isStarted() && CSKOTHEvent.isPlayerParticipant(_charObjId))) {
                _canTeleport = false;
            }
		}
	}
	...
	protected final void writeImpl()
	{
		...
		if (_activeChar.isPlayer())
		{
			...
			L2PcInstance activeChar = (L2PcInstance) _activeChar;
		...
		if (_canTeleport && (_clan != null) && !_isJailed)
		{
			...
			if(GabUtils.isInPvPInstance(_activeChar)){
                writeD(0x00); // 6d 01 00 00 00 - to hide away
                writeD(0x00); // 6d 02 00 00 00 - to castle
                writeD(0x00); // 6d 03 00 00 00 - to siege HQ
                writeD(0x00); // sweepable  (blue glow)
                writeD(0x01); // 6d 04 00 00 00 - to FIXED
