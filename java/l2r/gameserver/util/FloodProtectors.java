...
public final class FloodProtectors
{
     ...
     * Use-item flood protector.
     */
    private final FloodProtectorAction _usePotion728;
    private final FloodProtectorAction _usePotion1539;
    private final FloodProtectorAction _usePotion5591;
    private final FloodProtectorAction _usePotion5592;
    private final FloodProtectorAction _usePotion10410;
	/**
	...
	public FloodProtectors(final L2GameClient client)
	{
        ...
        _usePotion728 = new FloodProtectorAction(client, FloodProtectorsConfig.FLOOD_PROTECTOR_USE_POTION_728);
        _usePotion10410 = new FloodProtectorAction(client, FloodProtectorsConfig.FLOOD_PROTECTOR_USE_POTION_10410);
        _usePotion5592 = new FloodProtectorAction(client, FloodProtectorsConfig.FLOOD_PROTECTOR_USE_POTION_5592);
        _usePotion5591 = new FloodProtectorAction(client, FloodProtectorsConfig.FLOOD_PROTECTOR_USE_POTION_5591);
        _usePotion1539 = new FloodProtectorAction(client, FloodProtectorsConfig.FLOOD_PROTECTOR_USE_POTION_1539);
    ...
    public FloodProtectorAction get_usePotion728() {
        return _usePotion728;
    }

    public FloodProtectorAction get_usePotion1539() {
        return _usePotion1539;
    }

    public FloodProtectorAction get_usePotion5591() {
        return _usePotion5591;
    }

    public FloodProtectorAction get_usePotion5592() {
        return _usePotion5592;
    }

    public FloodProtectorAction get_usePotion10410() {
        return _usePotion10410;
    }
	/**
	 * Returns {@link #_useItem}.
	 * @return {@link #_useItem}
