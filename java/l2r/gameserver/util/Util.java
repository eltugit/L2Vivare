...
public final class Util
{
    ...
    private static final Pattern _pattern2 = Pattern.compile("<!--(TEMPLATE|TEMPLET)(\\d+)(.*?)(TEMPLATE|TEMPLET)-->", Pattern.DOTALL);

    public static Map<Integer, String> parseTemplate2(String html) {
        Matcher m = _pattern2.matcher(html);
	...
	/**
	 * directions: 0 = front 90 = right 180 = back 270 = left maxAngle = 120 default for front and back
	 * @param actor
	 * @param target
	 * @param direction
	 * @param maxAngle
	 * @return
	 */
	public final static boolean isOnAngle(L2Object actor, L2Object target, int direction, int maxAngle)
	{
		boolean value = false;
