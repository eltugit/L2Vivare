 ...
 */
package scripts.ai.grandboss.Antharas;
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon) {
		if (zone.isCharacterInZone(killer)) {
			if (npc.getId() == ANTHARAS) {
				...
				long respawnTime;
				if (GrandBossesConfig.ANTHARAS_CUSTOM_SPAWN_ENABLED && GrandBossesConfig.FindNext(GrandBossesConfig.ANTHARAS_CUSTOM_SPAWN_TIMES) != null)
					respawnTime = GrandBossesConfig.FindNext(GrandBossesConfig.ANTHARAS_CUSTOM_SPAWN_TIMES).getTimeInMillis() - System.currentTimeMillis();
				else {
					respawnTime = (Config.ANTHARAS_SPAWN_INTERVAL + getRandom(-Config.ANTHARAS_SPAWN_RANDOM, Config.ANTHARAS_SPAWN_RANDOM)) * 3600000;
				}
