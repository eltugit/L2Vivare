...
public final class Core extends AbstractNpcAI
{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		if (npc.getId() == CORE)
		{
            ...
            long respawnTime;
            if(GrandBossesConfig.CORE_CUSTOM_SPAWN_ENABLED && GrandBossesConfig.FindNext(GrandBossesConfig.CORE_CUSTOM_SPAWN_TIMES) != null)
                respawnTime = GrandBossesConfig.FindNext(GrandBossesConfig.CORE_CUSTOM_SPAWN_TIMES).getTimeInMillis() - System.currentTimeMillis();
            else {
                respawnTime = (Config.CORE_SPAWN_INTERVAL + getRandom(-Config.CORE_SPAWN_RANDOM, Config.CORE_SPAWN_RANDOM)) * 3600000;
            }
