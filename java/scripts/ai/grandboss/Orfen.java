...
public final class Orfen extends AbstractNpcAI
{
	...
	public Orfen()
	{
		super(Orfen.class.getSimpleName(), "ai/grandboss");
		int[] mobs =
		{
			ORFEN,
			RAIKEL_LEOS,
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		if (npc.getId() == ORFEN)
		{
            ...
            long respawnTime;
            if(GrandBossesConfig.ORFEN_CUSTOM_SPAWN_ENABLED && GrandBossesConfig.FindNext(GrandBossesConfig.ORFEN_CUSTOM_SPAWN_TIMES) != null)
                respawnTime = GrandBossesConfig.FindNext(GrandBossesConfig.ORFEN_CUSTOM_SPAWN_TIMES).getTimeInMillis() - System.currentTimeMillis();
            else
			    respawnTime = (Config.ORFEN_SPAWN_INTERVAL + getRandom(-Config.ORFEN_SPAWN_RANDOM, Config.ORFEN_SPAWN_RANDOM)) * 3600000;
