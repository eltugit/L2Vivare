...
public final class QueenAnt extends AbstractNpcAI
{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if (npcId == QUEEN)
		{
            ...
            long respawnTime;
            if(GrandBossesConfig.ANTQUEEN_CUSTOM_SPAWN_ENABLED && GrandBossesConfig.FindNext(GrandBossesConfig.ANTQUEEN_CUSTOM_SPAWN_TIMES) != null)
                respawnTime = GrandBossesConfig.FindNext(GrandBossesConfig.ANTQUEEN_CUSTOM_SPAWN_TIMES).getTimeInMillis() - System.currentTimeMillis();
            else
                respawnTime = (Config.QUEEN_ANT_SPAWN_INTERVAL + getRandom(-Config.QUEEN_ANT_SPAWN_RANDOM, Config.QUEEN_ANT_SPAWN_RANDOM)) * 3600000;
