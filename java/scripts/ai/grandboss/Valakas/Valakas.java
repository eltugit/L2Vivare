 ...
 */
package scripts.ai.grandboss.Valakas;
...
public final class Valakas extends AbstractNpcAI {
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon) {
		if (zone.isCharacterInZone(killer)) {
			...
			long respawnTime;
			if (GrandBossesConfig.VALAKAS_CUSTOM_SPAWN_ENABLED && GrandBossesConfig.FindNext(GrandBossesConfig.VALAKAS_CUSTOM_SPAWN_TIMES) != null)
				respawnTime = GrandBossesConfig.FindNext(GrandBossesConfig.VALAKAS_CUSTOM_SPAWN_TIMES).getTimeInMillis() - System.currentTimeMillis();
			else
				respawnTime = (Config.VALAKAS_SPAWN_INTERVAL + getRandom(-Config.VALAKAS_SPAWN_RANDOM, Config.VALAKAS_SPAWN_RANDOM)) * 3600000;
