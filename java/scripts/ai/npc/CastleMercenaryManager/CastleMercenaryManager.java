 ...
 */
package scripts.ai.npc.CastleMercenaryManager;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.nextToken())
		{
			case "limit":
			{
				...
				{
					html.setHtml(getHtm(player, player.getHtmlPrefix(), "mercmanager-aden-limit.html"));
				}
				else if (castle.getName().equals("rune"))
				{
					html.setHtml(getHtm(player, player.getHtmlPrefix(), "mercmanager-rune-limit.html"));
				}
				else
				{
					html.setHtml(getHtm(player, player.getHtmlPrefix(), "mercmanager-limit.html"));
				}
