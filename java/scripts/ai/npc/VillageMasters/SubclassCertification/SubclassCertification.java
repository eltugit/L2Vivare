 ...
 */
package scripts.ai.npc.VillageMasters.SubclassCertification;
...
public final class SubclassCertification extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			player.sendMessage("This service has been turned off. Please Learn the Certification through the new system (Alt + B community board)");
			return "<html><body> This option is disabled, use the new certification npc/community board </body></html>";
		}
