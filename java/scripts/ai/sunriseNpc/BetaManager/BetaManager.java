package scripts.ai.sunriseNpc.BetaManager;
...
public class BetaManager extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("noble-stone"))
		{
			...
			return "items.htm";
		}else if (event.equalsIgnoreCase("custom-coins"))
		{
			st.giveItems(23001, 1000000);
			st.giveItems(23003, 1000000);
			st.giveItems(23004, 1000000);
			st.giveItems(30008, 1000000);
			st.giveItems(75001, 1000000);
			st.giveItems(75006, 1000000);
			st.giveItems(30003, 1000000);
			st.giveItems(77567, 50);
			return "items.htm";
		}
