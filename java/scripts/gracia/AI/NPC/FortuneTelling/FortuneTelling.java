 ...
 */
package scripts.gracia.AI.NPC.FortuneTelling;
...
public class FortuneTelling extends AbstractNpcAI
{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		else
		{
			...
			htmltext = getHtm(player, player.getHtmlPrefix(), "fortune.htm").replace("%fortune%", String.valueOf(getRandom(1800309, 1800695)));
		}
		return htmltext;
	}
}