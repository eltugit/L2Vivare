...
public class AdminSiege implements IAdminCommandHandler
{
	...
	private void showCastleSelectPage(L2PcInstance activeChar)
	{
		...
		adminReply.setFile(activeChar, activeChar.getHtmlPrefix(), "data/html/admin/castles.htm");
		final StringBuilder cList = new StringBuilder(500);
		for (Castle castle : CastleManager.getInstance().getCastles())
		{
		    if(castle.getCastleId() == 10)
		        continue;
			if (castle != null)
			{
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar, activeChar.getHtmlPrefix(), "data/html/admin/castle.htm");
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar, activeChar.getHtmlPrefix(), "data/html/admin/castlesiegetime.htm");
	...
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage();
		adminReply.setFile(activeChar, activeChar.getHtmlPrefix(), "data/html/admin/clanhall.htm");
	...
	private void showSiegableHallPage(L2PcInstance activeChar, SiegableHall hall)
	{
		...
		msg.setFile(activeChar, activeChar.getHtmlPrefix(), "data/html/admin/siegablehall.htm");
