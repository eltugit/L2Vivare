...
public class ChatTrade implements IChatHandler
{
	...
	public void handleChat(int type, L2PcInstance activeChar, String target, String text)
	{
        ...
        if(GabConfig.CHAT_TRADE && activeChar.getPvpKills() < GabConfig.PVPS_TO_USE_CHAT_TRADE){
            activeChar.sendMessage(String.format("You need at least %d pvp kills to use this chat", GabConfig.PVPS_TO_USE_CHAT_TRADE));
            return;
        }
