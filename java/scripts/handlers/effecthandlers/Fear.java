...
public class Fear extends L2Effect
{
	...
	{
		if ((getEffected() instanceof L2NpcInstance) || (getEffected() instanceof L2RaidBossInstance) || (getEffected() instanceof L2GrandBossInstance) || (getEffected() instanceof L2DefenderInstance) || (getEffected() instanceof L2FortCommanderInstance) || (getEffected() instanceof L2SiegeFlagInstance) || (getEffected().getTemplate().getRace() == Race.SIEGE_WEAPON))
		{
			return false;
		}
