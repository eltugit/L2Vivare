	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		for (L2Character character : characters)
		{
			...
			if (activeChar != character)
			{
                ...
                if(character instanceof L2PcInstance && activeChar instanceof L2PcInstance){
                    activeChar.getActingPlayer().getMuseumPlayer().addData("healing_given", (long) amount);
                    character.getActingPlayer().getMuseumPlayer().addData("healing_received", (long) amount);
                }
			}
			else
			{
