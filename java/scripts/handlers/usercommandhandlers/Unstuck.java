 ...
 */
package scripts.handlers.usercommandhandlers;
...
public class Unstuck implements IUserCommandHandler
{
    ...
    public boolean useUserCommand(int id, L2PcInstance activeChar)
    {
        ...
        {
            activeChar.sendMessage("You cannot use this function while you are in the Instance Zone.");
            return false;
        }
    ...
    private static class EscapeFinalizer implements Runnable
    {
        ...
        public void run()
        {
            ...
            PvPZoneManager.handleLeavePvPZone(_activeChar, true);
