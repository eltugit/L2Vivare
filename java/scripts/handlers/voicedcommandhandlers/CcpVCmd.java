...
public class CcpVCmd implements IVoicedCommandHandler
{
    private static final String[] VOICED_COMMANDS =
            {
                    ...
                    "blockshotsanime",
                    "shotsonenter",
                    "tradeprot", "blockskillanime", "hideDressMe"
            };
    ...
    public static void sendHtml(L2PcInstance player)
    {
        ...
        builder.append("<tr>");
        builder.append("<td width=110><font color=898989>Block Skill Animation:</font></td>");
        builder.append("<td width=60><button value=\"Change\" action=\"bypass -h voice .blockskillanime\" width=60 height=21 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.button_df\"></td>");
