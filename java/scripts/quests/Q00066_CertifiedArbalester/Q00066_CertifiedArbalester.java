 ...
 */
package scripts.quests.Q00066_CertifiedArbalester;
...
public final class Q00066_CertifiedArbalester extends Quest
{
	...
	// Quest Monster
	private static final int Nemeziz_LADY = 27336;
	// Misc
	...
	public Q00066_CertifiedArbalester()
	{
		...
		addKillId(GRANITIC_GOLEM, HANGMAN_TREE, AMBER_BASILISK, STRAIN, GHOUL, DEAD_SEEKER, GRANDIS, MANASHEN_GARGOYLE, TIMAK_ORC, TIMAK_ORC_ARCHER, DELU_LIZARDMAN_SHAMAN, WATCHMAN_OF_THE_PLAINS, ROUGHLY_HEWN_ROCK_GOLEM, DELU_LIZARDMAN_SUPPLIER, DELU_LIZARDMAN_AGENT, CURSED_SEER, DELU_LIZARDMAN_COMMANDER, Nemeziz_LADY);
			...
			switch (npc.getId())
			{
				...
				case TIMAK_ORC_ARCHER:
				{
					if (qs.isMemoState(32))
					{
						...
						{
							qs.setMemoStateEx(1, 0);
							addSpawn(Nemeziz_LADY, npc, true, 0, false);
						}
					}
					break;
				}
