 ...
 */
package scripts.quests.Q00221_TestimonyOfProsperity;
...
public final class Q00221_TestimonyOfProsperity extends Quest
{
	...
	private static final int Nemeziz_MOSS = 3266;
	...
	private static final int GIANT_Nemeziz_ANT = 20228;
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if ((qs != null) && qs.isStarted() && Util.checkIfInRange(1500, npc, killer, true))
		{
			switch (npc.getId())
			{
				...
				case GIANT_Nemeziz_ANT:
				{
					if (hasQuestItems(killer, RING_OF_TESTIMONY_1ST, BRIGHTS_LIST) && !hasQuestItems(killer, EMILYS_RECIPE))
					{
						if ((getQuestItemsCount(killer, Nemeziz_MOSS) < 10))
						{
							giveItems(killer, Nemeziz_MOSS, 1);
							if (getQuestItemsCount(killer, Nemeziz_MOSS) == 10)
							{
								playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							}
			...
			switch (npc.getId())
			{
				...
				case GUARD_BRIGHT:
				{
					if (hasQuestItems(player, RING_OF_TESTIMONY_1ST))
					{
						...
						{
							if ((getQuestItemsCount(player, MANDRAGORA_PETAL) < 20) || (getQuestItemsCount(player, Nemeziz_MOSS) < 10))
							{
							...
							else
							{
								...
								takeItems(player, Nemeziz_MOSS, -1);
