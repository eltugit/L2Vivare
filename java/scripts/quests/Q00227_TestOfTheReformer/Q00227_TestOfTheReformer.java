 ...
 */
package scripts.quests.Q00227_TestOfTheReformer;
...
public final class Q00227_TestOfTheReformer extends Quest
{
	...
	private static final int Nemeziz_WEREWOLF = 27131;
	...
	public Q00227_TestOfTheReformer()
	{
		...
		addAttackId(NAMELESS_REVENANT, Nemeziz_WEREWOLF);
		addKillId(MISERY_SKELETON, SKELETON_ARCHER, SKELETON_MARKSMAN, SKELETON_LORD, SILENT_HORROR, NAMELESS_REVENANT, ARURAUNE, OL_MAHUM_INSPECTOR, OL_MAHUM_BETRAYER, OL_MAHUM_BETRAYER, Nemeziz_WEREWOLF, KRUDEL_LIZARDMAN);
		addSpawnId(OL_MAHUM_PILGRIM, OL_MAHUM_INSPECTOR, OL_MAHUM_BETRAYER, Nemeziz_WEREWOLF, KRUDEL_LIZARDMAN);
		...
		switch (event)
		{
			...
			case "30669-03.html":
			{
				...
				if (npc.getSummonedNpcCount() < 1)
				{
					...
					L2Npc wolf = addSpawn(Nemeziz_WEREWOLF, -9382, -89852, -2333, 0, false, 0);
