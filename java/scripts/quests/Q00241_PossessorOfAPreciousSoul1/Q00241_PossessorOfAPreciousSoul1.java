 ...
 */
package scripts.quests.Q00241_PossessorOfAPreciousSoul1;
...
public class Q00241_PossessorOfAPreciousSoul1 extends Quest
{
	...
	public Q00241_PossessorOfAPreciousSoul1()
	{
		...
		registerQuestItems(LEGEND_OF_SEVENTEEN, MALRUK_SUCCUBUS_CLAW, ECHO_CRYSTAL, POETRY_BOOK, Nemeziz_MOSS, RAHORAKTIS_MEDICINE);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "31336-02.html":
				...
				break;
			case "31336-05.html":
				if (st.isCond(15) && (st.getQuestItemsCount(Nemeziz_MOSS) >= 5))
				{
					st.takeItems(Nemeziz_MOSS, -1);
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		switch (npc.getId())
		{
			...
			case TAIK_ORC_SUPPLY_LEADER:
				...
				st = getQuestState(partyMember, false);
				if ((Nemeziz_MOSS_CHANCE >= getRandom(100)) && (st.getQuestItemsCount(Nemeziz_MOSS) < 5))
				{
					st.giveItems(Nemeziz_MOSS, 1);
					if (st.getQuestItemsCount(Nemeziz_MOSS) >= 5)
					{
						st.setCond(15, true);
					}
					else
