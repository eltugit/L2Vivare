 ...
 */
package scripts.quests.Q00254_LegendaryTales;
...
public class Q00254_LegendaryTales extends Quest
{
    ...
    public static void checkKilledRaids(L2PcInstance player, int var)
    {
        player.sendMessage("=== Remaining Dragon(s) ===");
        CreatureSay np = new CreatureSay(0, Say2.TELL, "Legendary Tales", "=== Remaining Dragon(s) ===");
        ...
        for (int i : raids)
        {
            ...
            if ((var & mask) == 0)
            {
                String name = getRaidName(i);
                player.sendMessage(name);
                np = new CreatureSay(0, Say2.TELL, "Legendary Tales", name);
                player.sendPacket(np);
            }
        }
    }

    private static String getRaidName(int raidId){
	    switch (raidId){
            case 25718: return "Emerald Horn";
            case 25719: return "Dust Rider";
            case 25720: return "Bleeding Fly";
            case 25721: return "Black Dagger Wing";
            case 25722: return "Shadow Summoner";
            case 25723: return "Spike Slasher";
            case 25724: return "Muscle Bomber";
        }
        return "";
    }
