 ...
 */
package scripts.quests.Q10277_MutatedKaneusDion;
...
public class Q10277_MutatedKaneusDion extends Quest
{
	...
	private static final int Nemeziz_HATU = 18558;
	...
	public Q10277_MutatedKaneusDion()
	{
		...
		addKillId(Nemeziz_HATU, SEER_FLOUROS);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if (killer.getParty() != null)
		{
			...
			for (L2PcInstance member : killer.getParty().getMembers())
			{
				...
				if ((st != null) && st.isStarted() && (((npcId == Nemeziz_HATU) && !st.hasQuestItems(TISSUE_CH)) || ((npcId == SEER_FLOUROS) && !st.hasQuestItems(TISSUE_SF))))
				{
					PartyMembers.add(st);
				}
			}
	...
	{
		if ((npcId == Nemeziz_HATU) && !st.hasQuestItems(TISSUE_CH))
		{
