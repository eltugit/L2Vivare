 ...
 */
package scripts.quests.TerritoryWarScripts;
...
import scripts.quests.Q00147_PathtoBecominganEliteMercenary.Q00147_PathtoBecominganEliteMercenary;
import scripts.quests.Q00148_PathtoBecominganExaltedMercenary.Q00148_PathtoBecominganExaltedMercenary;
import scripts.quests.Q00176_StepsForHonor.Q00176_StepsForHonor;
        ...
        if (questId < 0)
        {
            ...
            else
            {
                ...
                if(!GabConfig.CUSTOM_TW_TIME) {
                    ...
                    cal.set(Calendar.DAY_OF_WEEK, GabConfig.SIEGEDAY_TW);
                    cal.set(Calendar.HOUR_OF_DAY, GabConfig.HOUR_TW);
                    cal.set(Calendar.MINUTE, GabConfig.MINUTE_TW);
                    cal.set(Calendar.SECOND, 0);
                }
                if (cal.before(Calendar.getInstance()))
                {
                    cal.add(Calendar.WEEK_OF_YEAR, GabConfig.NEXT_TIME_TW);
                }
